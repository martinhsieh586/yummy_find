...
//IN
/*LINE使用JSON，將資料丟給程式，程式接收訊息($bodyMsg)
後，可放入line-db.json與log.txt儲存，亦可讓程式繼續處理
($obj)*/
...
//$event['source']['userId']; 為UserID
//$event['message']['text']; LINE傳送過來的訊息
//$event['timestamp'] 時間
//$event['replyToken'] 要回覆的對象
